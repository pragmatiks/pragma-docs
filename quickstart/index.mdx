---
title: "Quickstart"
description: "Choose your path to start building with pragma-os"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Create a Custom Provider" icon="plug" href="/quickstart/expert">
    Extend pragma-os by building and deploying your own provider. Define resource types, implement lifecycle methods, and ship it.
